...
export const GlobalStyle = createGlobalStyle`
	...
	*/
	.select-search__row:not(:first-child) {
		border-top: ${(props: bwgr.style.Props) => props.theme.border.soft};
	}
	...
	*/
	...
	.select-search__option.is-selected {
		background: ${(props: bwgr.style.Props) => props.theme.accents.super};
		color: ${(props: bwgr.style.Props) => props.theme.text.main};
	}

	.select-search__option.is-highlighted,
	.select-search__option:not(.is-selected):hover {
		background: ${(props: bwgr.style.Props) => props.theme.accents.main};
	}
