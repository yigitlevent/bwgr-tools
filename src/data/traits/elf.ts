...
export const ElfCommon: TraitCategory = {
	...
	traits: [
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "Do not have to take Health tests for illness." },
				{ type: "Basic", subtype: "Conditional", description: " +1D to Health and Forte tests for resisting fatigue and poison." }
			]
		},
		{
			allowed: ["bwg"],
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Stat", limit: { Perception: { min: 1, max: 9 } } }
			]
		},
		{
			allowed: ["bwg"],
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "+1D to all Perception-based (or Observation-based) field maneuvers for Range and Cover or any Perception test involving seeing long distances." },
				{ type: "Basic", subtype: "Conditional", description: "See in starlight as if it were day." }
			]
		}
	]
};
	...
	traits: [
		{
			...
			type: "Die",
			effects: [
				{ type: "Skill", roundUpByRoot: "Perception" }
			]
		},
		{
			allowed: ["bwg"],
		...
		},
		{
			...
			type: "Call-on",
			effects: [
				{ type: "Attribute", callon: { attribute: "Steel", condition: "In the Duel of Wits." } }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "If has a relationship with an important or powerful captain, increase base Circles by one." }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Resource", free: { resourceType: "Affiliation", description: "1D, with Elven Etharchs." } }
			]
		},
		{
			allowed: ["bwg"],
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "If the player purchases an important relationship with his mentor he gains a 1D reputation as his student; if he purchases a powerful relationship, he gains a 2D reputation." }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Call-on",
			effects: [
				{ type: "Stat", callon: { statName: "Power", condition: "When lifting something that is obviously too heavy, bulky or cumbersome." } }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "+1D to one reputation or affiliation." }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Call-on",
			effects: [
				{ type: "Skill", callon: { skillPath: "Any General➞Administration" } },
				{ type: "Skill", callon: { skillPath: "Any General➞Estate Management" } },
				{ type: "Skill", callon: { skillPath: "Any General➞Accounting" } }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Attribute", modify: { attribute: "Circles", modifier: 1 } }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "If has a Belief and an Instinct relating to the welfare of his city, get a 2D reputation and 2D major affiliation in and around the citadel." }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Resource", free: { resourceType: "Affiliation", description: "With the Swords of the White Towers." } }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "If a Belief describes vow to defend the citadel/Wilderlands/royalty, recieve a 2D reputation (he's the boss) and a 2D major affiliation within the Protectors" }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "Gain a free relationship with the Lord Protector provided there is a Belief about him." }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Call-on",
			effects: [
				{ type: "Skill", callon: { skillPath: "Any General➞Persuasion" } },
				{ type: "Skill", callon: { skillPath: "Any General➞Oratory" } },
				{ type: "Skill", callon: { skillPath: "Any General➞Interrogation" } },
				{ type: "Skill", callon: { skillPath: "Any General➞Seduction" } }
			]
		}
	]
};
	...
	traits: [
		{
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "Double your Will for Body of Argument when  kindness, compassion, Grief, or passion are involved." }
			]
		},
		{
			allowed: ["bwc"],
			...
			effects: [
				{ type: "Skill", callon: { skillPath: "Any General➞Sleight of Hand" } },
				{ type: "Skill", callon: { skillPath: "Any General➞Falsehood" } },
				{ type: "Basic", subtype: "Obstacle", description: "+1 Ob penalty to all Oratory, Command tests." },
				{ type: "Basic", subtype: "Obstacle", description: "+2 Ob to Ugly Truth or Litany of Fools." }
			]
		},
		{
			allowed: ["bwc"],
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Attribute", modify: { attribute: "Hesitation", modifier: -1 } },
				{ type: "Basic", subtype: "Obstacle", description: "+1 Ob to all social skill tests." },
				{ type: "Attribute", conditionalModify: { attribute: "Circles", modifier: -1, ifHasTrait: "Elf Lifepath➞Prince of the Blood" } }
			]
		},
		{
			allowed: ["bwc"],
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "If gets tried to be influenced by passion, motivation, joy or love, +1D advantage to all tests for one scene when confronting, hunting or poisoning." }
			]
		},
		{
			allowed: ["bwc"],
			...
			type: "Die",
			effects: [
				{ type: "Attribute", enable: "Spite", disable: "Grief" }
			]
		},
		{
			allowed: ["bwc"],
			...
			type: "Call-on",
			effects: [
				{ type: "Skill", callon: { skillPath: "Any General➞Sleight of Hand", condition: "If there is a thievery related related instinct." } }
			]
		},
		{
			allowed: ["bwc"],
			...
			type: "Die",
			effects: [
				{ type: "Basic", subtype: "Conditional", description: "After getting defeated Duel of With or a Fight, can fork Spite into all rolls bent on avenging himself against that enemy. Humiliating or murdering the enemy immediately earns the player a bonus persona point, for a total of two: one for a personal goal and one for Vengeful. Requires that the Dark Elf have a close relationship with a non-spiteful Elf or a mortal human." }
			]
		}
	]
};
	...
	traits: [
		{
			...
			type: "Die",
			effects: [
				{ type: "Attribute", modify: { attribute: "Grief", modifier: 1 } },
				{ type: "Resource", free: { resourceType: "Affiliation", description: "Infamous, among all Elves." } }
			]
		},
		{
			allowed: ["bwg"],
		...
		},
		{
			...
			type: "Die",
			effects: [
				{ type: "Attribute", freeExponent: "Grief" }
			]
		},
		{
			allowed: ["bwg"],
			...
			effects: [
				{ type: "Attribute", modify: { attribute: "Grief", modifier: 1 } },
				{ type: "Resource", free: { resourceType: "Reputation", description: "Infamous, all Elven people." } },
				{ type: "Basic", subtype: "Conditional", description: "+1D to Intimidate/Silent Fury any Elf." }
			]
		},
		{
			allowed: ["bwg"],
			...
			type: "Die",
			effects: [
				{ type: "Attribute", modify: { attribute: "Grief", modifier: -2 } },
				{ type: "Basic", subtype: "Obstacle", description: "All Grief tests are taken at -1 Ob." }
			]
		},
		{
			allowed: ["bwg"],
