...
export function AttributeButton({ name, value, disabled, onClick, onContext }: { name: AttributesList; value: number | ShadesList; disabled?: boolean; onClick?: OnClickFunction<AttributesList>; onContext?: OnClickFunction<AttributesList>; }): JSX.Element {
	return <Button size="small" variant="outlined" sx={Style} disabled={disabled} onClick={(e) => onClick ? onClick(e, name, 1) : undefined} onContextMenu={(e) => onContext ? onContext(e, name, -1) : undefined}>{value}</Button>;
}
